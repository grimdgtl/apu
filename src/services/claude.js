...
function systemPrompt() {
  ...
  return [
    ...
    'zakazivanje), Google Drive (pretraga, čitanje i kreiranje dokumenata) i email ',
    '(čitanje nepročitanih, draftovi, slanje). Za prebacivanje sadržaja između Drive-a i ',
    'Notion-a kombinuj alate (npr. drive_read + notion_add_knowledge). Koristi alate kad su ',
    'potrebni; ne izmišljaj podatke.',
    '',
    'Pravila:',
